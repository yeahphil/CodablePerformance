...
//  CodablePerformance
//
//  Created by Phillip Kast on 1/14/25.
...
extension ISO8601DateFormatter {
  static let iso8601: UncheckedSendable<ISO8601DateFormatter> = {
    let formatter = ISO8601DateFormatter()
    formatter.formatOptions = [.withInternetDateTime]
    return UncheckedSendable(formatter)
  }()

  static let iso8601WithFractionalSeconds: UncheckedSendable<ISO8601DateFormatter> = {
    let formatter = ISO8601DateFormatter()
